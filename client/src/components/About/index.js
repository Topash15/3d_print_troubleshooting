      ...
      <div>
        ...
        <div className="about-container grid">
          <div className="about-grid-item">
            <h2 className="about-grid-item-title">Our Goal</h2>
            <p className="about-grid-item-text">
          ...
          <div className="about-grid-item">
            <h2 className="about-grid-item-title">How do we make it easy to troubleshoot?</h2>
            <p className="about-grid-item-text">
              We are creating a collection of problems that you may experience
              as well as the steps required to resolve those problems. To get
              ...
              <i>Solved</i> button. We collect how often a step resolves a
              problem so we can adjust the order to shorten the troubleshooting
